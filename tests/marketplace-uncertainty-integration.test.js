...
const out=evaluateOpportunity({
  ...
  history:{sampleCount:16,spanDays:60,confidence:94,historyCoverageScore:96,madPct:2,regimeStabilityScore:94},anomaly:{confidence:93,phase:'new-drop',madPct:2,regimeStabilityScore:94},deal:{fresh:true,verified:true},sourceEvidence:{retailer:strong,resale:strong},asOf
});
...
assert.equal(out.economics.decisionFloorRoi,Math.min(...[out.economics.sourceAdjustedRoi,out.economics.sourceAdjustedDownsideRoi,out.economics.sourceAdjustedConfidenceAdjustedRoi,out.economics.decayAdjustedRoi,out.economics.marketplaceLateSaleRoi,out.economics.marketplaceUncertaintyRoi,out.economics.marketSpreadAdjustedRoi].filter(Number.isFinite)));
