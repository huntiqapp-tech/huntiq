...

{
  ...
  const e=pc.adjustEconomics({profit:100,roi:120},a);assert(e.consensusAdjustedProfit>90);assert(e.consensusAdjustedRoi>108);
}
{
  const a=pc.assess([
    {source:'retailer-page',price:49.03,observedAt:'2026-08-31T10:30:00Z'},
  ...
  const e=pc.adjustEconomics({profit:100,roi:120},a);assert(e.consensusAdjustedProfit<75);assert(e.consensusAdjustedRoi<90);
}
{
...
{
  const o=pc.applyToOpportunity({evidenceQuality:1,economics:{profit:80,roi:100},downsideEconomics:{profit:40,roi:50}},[{source:'one',price:50,observedAt:'2026-08-31T10:30:00Z'}],{now});
  assert(o.evidenceQuality<1);assert(o.priceConsensus);assert(o.economics.consensusAdjustedProfit<80);assert(o.downsideEconomics.consensusAdjustedRoi<50);
}
