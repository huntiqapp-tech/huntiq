...
function evaluateOpportunity({opportunity={},comparables=[],channels=[],history={},anomaly={},deal={},asOf}={}){
  ...
  const evidence=EvidenceGate.evaluateEvidence({history,anomaly,resale:{confidence:resale.resaleConfidence,resaleConfidence:resale.resaleConfidence,resaleFreshnessScore:resale.resaleFreshnessScore,newestSaleAgeDays:resale.newestSaleAgeDays,medianSaleAgeDays:resale.medianSaleAgeDays,soldCount90:resale.windows.d90.count,soldCount30:resale.windows.d30.count,priceIntegrity:resale.priceIntegrity,outlierCount:resale.outlierCount},economics,deal,liquidity:velocity});
