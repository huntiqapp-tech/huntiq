...
function evaluateOpportunity({opportunity={},comparables=[],channels=[],history={},anomaly={},deal={},asOf}={}){
  ...
  const evidence=EvidenceGate.evaluateEvidence({history,anomaly,resale:{confidence:resale.resaleConfidence,resaleConfidence:resale.resaleConfidence,soldCount90:resale.windows.d90.count,soldCount30:resale.windows.d30.count},economics,deal,liquidity:velocity});
