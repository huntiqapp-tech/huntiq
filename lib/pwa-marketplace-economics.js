...
function assessForOpportunity(deal={},evaluated={},rules={}){
 ...
 return costFloor.assessMarketplaceCostFloor({
  ...
  paymentFeeOnShipping:deal.paymentFeeOnShipping,
  paymentFeeOnSalesTax:deal.paymentFeeOnSalesTax,
