...
function buildDealCoach(deal={}){
  ...
  return{verdict,headline,summary,reasons:reasons.slice(0,5),cautions:cautions.slice(0,5),metrics:{dropPct:drop,anomalyConfidence,historyCoverage,resaleConfidence,soldCount:sold,liquidityScore:liquidity,profit,roi,downsideRoi,riskAdjustedProfit:riskProfit,maxBuyPrice:maxBuy,currentPrice:price},generatedFrom:'deterministic-evaluator-evidence'};
}
