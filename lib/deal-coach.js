...
function buildDealCoach(deal={}){
  const anomaly=deal.anomaly||{};const history=deal.historyAssessment||deal.history||{};const resale=deal.resale||{};const economics=deal.economics||{};const downside=deal.downsideEconomics||deal.downside||{};const risk=deal.riskAdjustedEconomics||{};const decision=deal.purchaseDecision||{};const alert=deal.alert||{};
  ...
  return{verdict,headline,summary,reasons,cautions,metrics:{dropPct:drop,anomalyConfidence,historyCoverage,resaleConfidence,soldCount:sold,liquidityScore:liquidity,profit,roi,downsideRoi,riskAdjustedProfit:riskProfit,maxBuyPrice:maxBuy,currentPrice:price},generatedFrom:'deterministic-evaluator-evidence'};
}
