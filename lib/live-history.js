...
function evaluateLiveAlert(observation, options = {}) {
  ...
  const fingerprint = baseFingerprint ? `${baseFingerprint}|${quantityFingerprint}` : quantityFingerprint;
  ...
  return { opportunity, notification, quantityDecision, historyKey: historyKey(observation) };
}
...
module.exports = { productKey, historyLocation, historyKey, buildHistoryIndex, priorPrices, observationContext, inventorySourceType, liveInventoryAssessment, evaluateLiveObservation, evaluateLiveAlert, toObservationRow };
