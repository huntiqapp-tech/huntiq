...
function historyKey(o = {}) {
  const channel = String(o.channel || (o.storeId || o.store_id || o.zip || o.zipcode ? 'local' : 'online')).toLowerCase();
  return [String(o.retailer || '').toLowerCase(), productKey(o), channel, historyLocation(o)].join('|');
}
...
function toObservationRow(o = {}) {
  ...
  return {
    ...
    quantity: o.quantity == null && o.inventory == null ? null : Number(o.quantity ?? o.inventory),
    ...
    source_url: o.url || o.sourceUrl || source.evidenceUrl || null
  };
}
