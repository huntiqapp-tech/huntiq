...
for(const d of deals){
  try{
    const asOf=(typeof appFeed!=='undefined'&&appFeed.asOf)||new Date().toISOString();
    d.dataState=d.dataState||root.HuntIQDataState.classifyOpportunityData(d,{asOf});
    const strict=root.HuntIQPwaOpportunity.evaluateForPwa(d,d,{asOf:d.observedAt||asOf});
